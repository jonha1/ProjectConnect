...
class Creator(Member):
    ...
    def deleteProject(creatorusername, title):
        ...
        try:
            ...
            print(f"Error in Creator.deleteProject for title '{title}' by '{creatorusername}': {e}")
    ...
    def archiveProject(creatorusername, title):
        ...
        try:
            ...
            print(f"Error in Creator.archiveProject for title '{title}' by '{creatorusername}': {e}")
            return {"error": f"An unexpected error occurred: {str(e)}"}
    ...
    def unarchiveProject(creatorusername, title):
        ...
        try:
            ...
            print(f"Error in Creator.unarchiveProject for title '{title}' by '{creatorusername}': {e}")
            return {"error": f"An unexpected error occurred: {str(e)}"}
