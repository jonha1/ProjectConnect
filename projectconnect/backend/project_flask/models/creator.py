...
class Creator(Member):
    ...
    def createProject(self, creatorusername, title, description, tag, **optional_fields):
        try:
            ...
            project_result = Project.buildProject(creatorusername, title, description, tag, **optional_fields)
